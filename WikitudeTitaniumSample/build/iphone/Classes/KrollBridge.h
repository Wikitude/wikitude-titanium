...
@interface WikitudeTestAppObject : KrollCoverageObject {
#else
@interface WikitudeTestAppObject : KrollObject {
#endif
@private
...
extern NSString * WikitudeTestApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	WikitudeTestAppObject *_wikitudetestapp;
    KrollObject* console;
	BOOL shutdown;
