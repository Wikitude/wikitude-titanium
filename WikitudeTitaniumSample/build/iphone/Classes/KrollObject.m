...
//@interface WikitudeTestAppObject : NSObject
//@end

@interface WikitudeTestAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WikitudeTestAppObject class]])
		{
			for (NSString *key in [[(WikitudeTestAppObject*)o modules] allKeys])
			{
