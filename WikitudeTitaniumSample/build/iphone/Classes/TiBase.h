...
// in simulator we redefine to format for WikitudeTestApp Developer console
...
{\
	NSString * exceptionName = [@"org.wikitudetestapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wikitudetestapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWikitudeTestAppNativeItemNone = -1, 
	UIWikitudeTestAppNativeItemSpinner = -2,
	UIWikitudeTestAppNativeItemProgressBar = -3,
	
	UIWikitudeTestAppNativeItemSlider = -4,
	UIWikitudeTestAppNativeItemSwitch = -5,
	UIWikitudeTestAppNativeItemMultiButton = -6,
	UIWikitudeTestAppNativeItemSegmented = -7,
	
	UIWikitudeTestAppNativeItemTextView = -8,
	UIWikitudeTestAppNativeItemTextField = -9,
	UIWikitudeTestAppNativeItemSearchBar = -10,
	
	UIWikitudeTestAppNativeItemPicker = -11,
	UIWikitudeTestAppNativeItemDatePicker = -12,
	
	UIWikitudeTestAppNativeItemInfoLight = -13,
	UIWikitudeTestAppNativeItemInfoDark = -14,
	
	UIWikitudeTestAppNativeItemDisclosure = -15,
	
	UIWikitudeTestAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WikitudeTestApp instances of
