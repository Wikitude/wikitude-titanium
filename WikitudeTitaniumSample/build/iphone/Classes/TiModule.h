...
/**
 The base class for all WikitudeTestApp modules
 */
...
/**
 WikitudeTestApp Platform calls this method on startup.
 */
-(void)startup;

/**
 WikitudeTestApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 WikitudeTestApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 WikitudeTestApp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 WikitudeTestApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
