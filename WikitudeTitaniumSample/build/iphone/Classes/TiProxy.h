...
//Rare exceptions to indicate a bug in the _wikitudetestapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for WikitudeTestApp proxies.
 */
