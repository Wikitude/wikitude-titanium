...
/**
 Base class for all WikitudeTestApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WikitudeTestApp view hierarchy (such as wrapped iOS UIViews) was touched.
